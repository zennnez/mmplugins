# credits: https://github.com/officialpiyush/modmail-plugins/tree/master/tags
...
class TagsPlugin(commands.Cog):
    ...
    async def claim(self, ctx: commands.Context, name: str):
        ...
        if tag is None:
            ...
            member = ctx.guild.get_member(tag["author"]) or await self.bot.fetch_user(tag["author"])
